...
const char *idCompiler::p_punctuation[] = {
	"+=", "-=", "*=", "/=", "%=", "&=", "|=", "++", "--",
	"&&", "||", "<=", ">=", "==", "!=", "::", ";",  ",",
	"~",  "!",  "*",  "/",  "%",  "(",   ")",  "-", "+",
	"=",  "[",  "]",  ".",  "<",  ">" ,  "&",  "|", ":",  NULL
...
idCompiler::idCompiler() {
	...
	for( p_punctuationPtr = p_punctuation; *p_punctuationPtr != NULL; p_punctuationPtr++ ) {
		id = parserPtr->GetPunctuationId( *p_punctuationPtr );
		if ( ( id >= 0 ) && ( id < 256 ) ) {
