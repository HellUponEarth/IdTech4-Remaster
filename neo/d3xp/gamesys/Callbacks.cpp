...
*/
	...
	*******************************************************/
	...
	case 513 :
		...
		( this->*( eventCallback_f_t )callback )( *( float * )&p_data[ 0 ] );
		break;
	...
	*******************************************************/
	...
	case 1025 :
		...
		( this->*( eventCallback_fi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ] );
		break;

	case 1026 :
		typedef void ( idClass::*eventCallback_if_t )( const intptr_t, const float );
		( this->*( eventCallback_if_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ] );
		break;

	case 1027 :
		typedef void ( idClass::*eventCallback_ff_t )( const float, const float );
		( this->*( eventCallback_ff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ] );
		break;
	...
	*******************************************************/
	...
	case 2049 :
		...
		( this->*( eventCallback_fii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ] );
		break;

	case 2050 :
		typedef void ( idClass::*eventCallback_ifi_t )( const intptr_t, const float, const intptr_t );
		( this->*( eventCallback_ifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ] );
		break;

	case 2051 :
		typedef void ( idClass::*eventCallback_ffi_t )( const float, const float, const intptr_t );
		( this->*( eventCallback_ffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ] );
		break;

	case 2052 :
		typedef void ( idClass::*eventCallback_iif_t )( const intptr_t, const intptr_t, const float );
		( this->*( eventCallback_iif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ] );
		break;

	case 2053 :
		typedef void ( idClass::*eventCallback_fif_t )( const float, const intptr_t, const float );
		( this->*( eventCallback_fif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ] );
		break;

	case 2054 :
		typedef void ( idClass::*eventCallback_iff_t )( const intptr_t, const float, const float );
		( this->*( eventCallback_iff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ] );
		break;

	case 2055 :
		typedef void ( idClass::*eventCallback_fff_t )( const float, const float, const float );
		( this->*( eventCallback_fff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ] );
		break;
	...
	*******************************************************/
	...
	case 16385 :
		...
		( this->*( eventCallback_fiiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16386 :
		...
		( this->*( eventCallback_ifiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16387 :
		...
		( this->*( eventCallback_ffiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16388 :
		...
		( this->*( eventCallback_iifiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16389 :
		...
		( this->*( eventCallback_fifiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16390 :
		...
		( this->*( eventCallback_iffiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16391 :
		...
		( this->*( eventCallback_fffiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16392 :
		...
		( this->*( eventCallback_iiifii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16393 :
		...
		( this->*( eventCallback_fiifii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16394 :
		...
		( this->*( eventCallback_ififii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16395 :
		...
		( this->*( eventCallback_ffifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16396 :
		...
		( this->*( eventCallback_iiffii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16397 :
		...
		( this->*( eventCallback_fiffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16398 :
		...
		( this->*( eventCallback_ifffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16399 :
		...
		( this->*( eventCallback_ffffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16400 :
		...
		( this->*( eventCallback_iiiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16401 :
		...
		( this->*( eventCallback_fiiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16402 :
		...
		( this->*( eventCallback_ifiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16403 :
		...
		( this->*( eventCallback_ffiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16404 :
		...
		( this->*( eventCallback_iififi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16405 :
		...
		( this->*( eventCallback_fififi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16406 :
		...
		( this->*( eventCallback_iffifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16407 :
		...
		( this->*( eventCallback_fffifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16408 :
		...
		( this->*( eventCallback_iiiffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16409 :
		...
		( this->*( eventCallback_fiiffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16410 :
		...
		( this->*( eventCallback_ififfi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16411 :
		...
		( this->*( eventCallback_ffiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16412 :
		...
		( this->*( eventCallback_iifffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16413 :
		...
		( this->*( eventCallback_fifffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16414 :
		...
		( this->*( eventCallback_iffffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;

	case 16415 :
		typedef void ( idClass::*eventCallback_fffffi_t )( const float, const float, const float, const float, const float, const intptr_t );
		( this->*( eventCallback_fffffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ] );
		break;
	...
	case 16416 :
		...
		( this->*( eventCallback_iiiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16417 :
		...
		( this->*( eventCallback_fiiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16418 :
		...
		( this->*( eventCallback_ifiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16419 :
		...
		( this->*( eventCallback_ffiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16420 :
		...
		( this->*( eventCallback_iifiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16421 :
		...
		( this->*( eventCallback_fifiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16422 :
		...
		( this->*( eventCallback_iffiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16423 :
		...
		( this->*( eventCallback_fffiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16424 :
		...
		( this->*( eventCallback_iiifif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16425 :
		...
		( this->*( eventCallback_fiifif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16426 :
		...
		( this->*( eventCallback_ififif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16427 :
		...
		( this->*( eventCallback_ffifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16428 :
		...
		( this->*( eventCallback_iiffif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16429 :
		...
		( this->*( eventCallback_fiffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16430 :
		...
		( this->*( eventCallback_ifffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16431 :
		typedef void ( idClass::*eventCallback_ffffif_t )( const float, const float, const float, const float, const intptr_t, const float );
		( this->*( eventCallback_ffffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16432 :
		...
		( this->*( eventCallback_iiiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16433 :
		...
		( this->*( eventCallback_fiiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16434 :
		...
		( this->*( eventCallback_ifiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16435 :
		...
		( this->*( eventCallback_ffiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16436 :
		...
		( this->*( eventCallback_iififf_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16437 :
		...
		( this->*( eventCallback_fififf_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16438 :
		...
		( this->*( eventCallback_iffiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16439 :
		typedef void ( idClass::*eventCallback_fffiff_t )( const float, const float, const float, const intptr_t, const float, const float );
		( this->*( eventCallback_fffiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16440 :
		...
		( this->*( eventCallback_iiifff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16441 :
		...
		( this->*( eventCallback_fiifff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16442 :
		...
		( this->*( eventCallback_ififff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16443 :
		typedef void ( idClass::*eventCallback_ffifff_t )( const float, const float, const intptr_t, const float, const float, const float );
		( this->*( eventCallback_ffifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	case 16444 :
		...
		( this->*( eventCallback_iiffff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16445 :
		typedef void ( idClass::*eventCallback_fiffff_t )( const float, const intptr_t, const float, const float, const float, const float );
		( this->*( eventCallback_fiffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16446 :
		typedef void ( idClass::*eventCallback_ifffff_t )( const intptr_t, const float, const float, const float, const float, const float );
		( this->*( eventCallback_ifffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;

	case 16447 :
		typedef void ( idClass::*eventCallback_ffffff_t )( const float, const float, const float, const float, const float, const float );
		( this->*( eventCallback_ffffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ] );
		break;
	...
	*******************************************************/
	...
	case 32769 :
		...
		( this->*( eventCallback_fiiiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32770 :
		...
		( this->*( eventCallback_ifiiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32771 :
		...
		( this->*( eventCallback_ffiiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32772 :
		...
		( this->*( eventCallback_iifiiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32773 :
		...
		( this->*( eventCallback_fifiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32774 :
		...
		( this->*( eventCallback_iffiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32775 :
		...
		( this->*( eventCallback_fffiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32776 :
		...
		( this->*( eventCallback_iiifiii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32777 :
		...
		( this->*( eventCallback_fiifiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32778 :
		...
		( this->*( eventCallback_ififiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32779 :
		...
		( this->*( eventCallback_ffifiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32780 :
		...
		( this->*( eventCallback_iiffiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32781 :
		...
		( this->*( eventCallback_fiffiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32782 :
		...
		( this->*( eventCallback_ifffiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32783 :
		...
		( this->*( eventCallback_ffffiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32784 :
		...
		( this->*( eventCallback_iiiifii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32785 :
		...
		( this->*( eventCallback_fiiifii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32786 :
		...
		( this->*( eventCallback_ifiifii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32787 :
		...
		( this->*( eventCallback_ffiifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32788 :
		...
		( this->*( eventCallback_iififii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32789 :
		...
		( this->*( eventCallback_fififii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32790 :
		...
		( this->*( eventCallback_iffifii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32791 :
		...
		( this->*( eventCallback_fffifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32792 :
		...
		( this->*( eventCallback_iiiffii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32793 :
		...
		( this->*( eventCallback_fiiffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32794 :
		...
		( this->*( eventCallback_ififfii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32795 :
		...
		( this->*( eventCallback_ffiffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32796 :
		...
		( this->*( eventCallback_iifffii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32797 :
		...
		( this->*( eventCallback_fifffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32798 :
		...
		( this->*( eventCallback_iffffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32799 :
		...
		( this->*( eventCallback_fffffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32800 :
		...
		( this->*( eventCallback_iiiiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32801 :
		...
		( this->*( eventCallback_fiiiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32802 :
		...
		( this->*( eventCallback_ifiiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32803 :
		...
		( this->*( eventCallback_ffiiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32804 :
		...
		( this->*( eventCallback_iifiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32805 :
		...
		( this->*( eventCallback_fifiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32806 :
		...
		( this->*( eventCallback_iffiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32807 :
		...
		( this->*( eventCallback_fffiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32808 :
		...
		( this->*( eventCallback_iiififi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32809 :
		...
		( this->*( eventCallback_fiififi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32810 :
		...
		( this->*( eventCallback_ifififi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32811 :
		...
		( this->*( eventCallback_ffififi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32812 :
		...
		( this->*( eventCallback_iiffifi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32813 :
		...
		( this->*( eventCallback_fiffifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32814 :
		...
		( this->*( eventCallback_ifffifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32815 :
		...
		( this->*( eventCallback_ffffifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32816 :
		...
		( this->*( eventCallback_iiiiffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32817 :
		...
		( this->*( eventCallback_fiiiffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32818 :
		...
		( this->*( eventCallback_ifiiffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32819 :
		...
		( this->*( eventCallback_ffiiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32820 :
		...
		( this->*( eventCallback_iififfi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32821 :
		...
		( this->*( eventCallback_fififfi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32822 :
		...
		( this->*( eventCallback_iffiffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32823 :
		...
		( this->*( eventCallback_fffiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32824 :
		...
		( this->*( eventCallback_iiifffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32825 :
		...
		( this->*( eventCallback_fiifffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32826 :
		...
		( this->*( eventCallback_ififffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32827 :
		...
		( this->*( eventCallback_ffifffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32828 :
		...
		( this->*( eventCallback_iiffffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32829 :
		...
		( this->*( eventCallback_fiffffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32830 :
		...
		( this->*( eventCallback_ifffffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32831 :
		...
		( this->*( eventCallback_ffffffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ] );
		break;
	...
	case 32832 :
		...
		( this->*( eventCallback_iiiiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32833 :
		...
		( this->*( eventCallback_fiiiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32834 :
		...
		( this->*( eventCallback_ifiiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32835 :
		...
		( this->*( eventCallback_ffiiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32836 :
		...
		( this->*( eventCallback_iifiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32837 :
		...
		( this->*( eventCallback_fifiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32838 :
		...
		( this->*( eventCallback_iffiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32839 :
		...
		( this->*( eventCallback_fffiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32840 :
		...
		( this->*( eventCallback_iiifiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32841 :
		...
		( this->*( eventCallback_fiifiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32842 :
		...
		( this->*( eventCallback_ififiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32843 :
		...
		( this->*( eventCallback_ffifiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32844 :
		...
		( this->*( eventCallback_iiffiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32845 :
		...
		( this->*( eventCallback_fiffiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32846 :
		...
		( this->*( eventCallback_ifffiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32847 :
		...
		( this->*( eventCallback_ffffiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32848 :
		...
		( this->*( eventCallback_iiiifif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32849 :
		...
		( this->*( eventCallback_fiiifif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32850 :
		...
		( this->*( eventCallback_ifiifif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32851 :
		...
		( this->*( eventCallback_ffiifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32852 :
		...
		( this->*( eventCallback_iififif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32853 :
		...
		( this->*( eventCallback_fififif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32854 :
		...
		( this->*( eventCallback_iffifif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32855 :
		...
		( this->*( eventCallback_fffifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32856 :
		...
		( this->*( eventCallback_iiiffif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32857 :
		...
		( this->*( eventCallback_fiiffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32858 :
		...
		( this->*( eventCallback_ififfif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32859 :
		...
		( this->*( eventCallback_ffiffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32860 :
		...
		( this->*( eventCallback_iifffif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32861 :
		...
		( this->*( eventCallback_fifffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32862 :
		...
		( this->*( eventCallback_iffffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32863 :
		...
		( this->*( eventCallback_fffffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32864 :
		...
		( this->*( eventCallback_iiiiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32865 :
		...
		( this->*( eventCallback_fiiiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32866 :
		...
		( this->*( eventCallback_ifiiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32867 :
		...
		( this->*( eventCallback_ffiiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32868 :
		...
		( this->*( eventCallback_iifiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32869 :
		...
		( this->*( eventCallback_fifiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32870 :
		...
		( this->*( eventCallback_iffiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32871 :
		...
		( this->*( eventCallback_fffiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32872 :
		...
		( this->*( eventCallback_iiififf_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32873 :
		...
		( this->*( eventCallback_fiififf_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32874 :
		...
		( this->*( eventCallback_ifififf_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32875 :
		...
		( this->*( eventCallback_ffififf_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32876 :
		...
		( this->*( eventCallback_iiffiff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32877 :
		...
		( this->*( eventCallback_fiffiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32878 :
		...
		( this->*( eventCallback_ifffiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32879 :
		...
		( this->*( eventCallback_ffffiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32880 :
		...
		( this->*( eventCallback_iiiifff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32881 :
		...
		( this->*( eventCallback_fiiifff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32882 :
		...
		( this->*( eventCallback_ifiifff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32883 :
		...
		( this->*( eventCallback_ffiifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32884 :
		...
		( this->*( eventCallback_iififff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32885 :
		...
		( this->*( eventCallback_fififff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32886 :
		...
		( this->*( eventCallback_iffifff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32887 :
		...
		( this->*( eventCallback_fffifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32888 :
		...
		( this->*( eventCallback_iiiffff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32889 :
		...
		( this->*( eventCallback_fiiffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32890 :
		...
		( this->*( eventCallback_ififfff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32891 :
		...
		( this->*( eventCallback_ffiffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32892 :
		...
		( this->*( eventCallback_iifffff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32893 :
		...
		( this->*( eventCallback_fifffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32894 :
		...
		( this->*( eventCallback_iffffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	case 32895 :
		...
		( this->*( eventCallback_fffffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ] );
		break;
	...
	*******************************************************/
	...
	case 65537 :
		...
		( this->*( eventCallback_fiiiiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65538 :
		...
		( this->*( eventCallback_ifiiiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65539 :
		...
		( this->*( eventCallback_ffiiiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65540 :
		...
		( this->*( eventCallback_iifiiiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65541 :
		...
		( this->*( eventCallback_fifiiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65542 :
		...
		( this->*( eventCallback_iffiiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65543 :
		...
		( this->*( eventCallback_fffiiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65544 :
		...
		( this->*( eventCallback_iiifiiii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65545 :
		...
		( this->*( eventCallback_fiifiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65546 :
		...
		( this->*( eventCallback_ififiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65547 :
		...
		( this->*( eventCallback_ffifiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65548 :
		...
		( this->*( eventCallback_iiffiiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65549 :
		...
		( this->*( eventCallback_fiffiiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65550 :
		...
		( this->*( eventCallback_ifffiiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65551 :
		...
		( this->*( eventCallback_ffffiiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65552 :
		...
		( this->*( eventCallback_iiiifiii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65553 :
		...
		( this->*( eventCallback_fiiifiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65554 :
		...
		( this->*( eventCallback_ifiifiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65555 :
		...
		( this->*( eventCallback_ffiifiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65556 :
		...
		( this->*( eventCallback_iififiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65557 :
		...
		( this->*( eventCallback_fififiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65558 :
		...
		( this->*( eventCallback_iffifiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65559 :
		...
		( this->*( eventCallback_fffifiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65560 :
		...
		( this->*( eventCallback_iiiffiii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65561 :
		...
		( this->*( eventCallback_fiiffiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65562 :
		...
		( this->*( eventCallback_ififfiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65563 :
		...
		( this->*( eventCallback_ffiffiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65564 :
		...
		( this->*( eventCallback_iifffiii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65565 :
		...
		( this->*( eventCallback_fifffiii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65566 :
		...
		( this->*( eventCallback_iffffiii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65567 :
		...
		( this->*( eventCallback_fffffiii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65568 :
		...
		( this->*( eventCallback_iiiiifii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65569 :
		...
		( this->*( eventCallback_fiiiifii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65570 :
		...
		( this->*( eventCallback_ifiiifii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65571 :
		...
		( this->*( eventCallback_ffiiifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65572 :
		...
		( this->*( eventCallback_iifiifii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65573 :
		...
		( this->*( eventCallback_fifiifii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65574 :
		...
		( this->*( eventCallback_iffiifii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65575 :
		...
		( this->*( eventCallback_fffiifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65576 :
		...
		( this->*( eventCallback_iiififii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65577 :
		...
		( this->*( eventCallback_fiififii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65578 :
		...
		( this->*( eventCallback_ifififii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65579 :
		...
		( this->*( eventCallback_ffififii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65580 :
		...
		( this->*( eventCallback_iiffifii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65581 :
		...
		( this->*( eventCallback_fiffifii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65582 :
		...
		( this->*( eventCallback_ifffifii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65583 :
		...
		( this->*( eventCallback_ffffifii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65584 :
		...
		( this->*( eventCallback_iiiiffii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65585 :
		...
		( this->*( eventCallback_fiiiffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65586 :
		...
		( this->*( eventCallback_ifiiffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65587 :
		...
		( this->*( eventCallback_ffiiffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65588 :
		...
		( this->*( eventCallback_iififfii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65589 :
		...
		( this->*( eventCallback_fififfii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65590 :
		...
		( this->*( eventCallback_iffiffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65591 :
		...
		( this->*( eventCallback_fffiffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65592 :
		...
		( this->*( eventCallback_iiifffii_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65593 :
		...
		( this->*( eventCallback_fiifffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65594 :
		...
		( this->*( eventCallback_ififffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65595 :
		...
		( this->*( eventCallback_ffifffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65596 :
		...
		( this->*( eventCallback_iiffffii_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65597 :
		...
		( this->*( eventCallback_fiffffii_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65598 :
		...
		( this->*( eventCallback_ifffffii_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65599 :
		...
		( this->*( eventCallback_ffffffii_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65600 :
		...
		( this->*( eventCallback_iiiiiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65601 :
		...
		( this->*( eventCallback_fiiiiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65602 :
		...
		( this->*( eventCallback_ifiiiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65603 :
		...
		( this->*( eventCallback_ffiiiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65604 :
		...
		( this->*( eventCallback_iifiiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65605 :
		...
		( this->*( eventCallback_fifiiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65606 :
		...
		( this->*( eventCallback_iffiiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65607 :
		...
		( this->*( eventCallback_fffiiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65608 :
		...
		( this->*( eventCallback_iiifiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65609 :
		...
		( this->*( eventCallback_fiifiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65610 :
		...
		( this->*( eventCallback_ififiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65611 :
		...
		( this->*( eventCallback_ffifiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65612 :
		...
		( this->*( eventCallback_iiffiifi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65613 :
		...
		( this->*( eventCallback_fiffiifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65614 :
		...
		( this->*( eventCallback_ifffiifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65615 :
		...
		( this->*( eventCallback_ffffiifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65616 :
		...
		( this->*( eventCallback_iiiififi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65617 :
		...
		( this->*( eventCallback_fiiififi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65618 :
		...
		( this->*( eventCallback_ifiififi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65619 :
		...
		( this->*( eventCallback_ffiififi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65620 :
		...
		( this->*( eventCallback_iifififi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65621 :
		...
		( this->*( eventCallback_fifififi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65622 :
		...
		( this->*( eventCallback_iffififi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65623 :
		...
		( this->*( eventCallback_fffififi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65624 :
		...
		( this->*( eventCallback_iiiffifi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65625 :
		...
		( this->*( eventCallback_fiiffifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65626 :
		...
		( this->*( eventCallback_ififfifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65627 :
		...
		( this->*( eventCallback_ffiffifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65628 :
		...
		( this->*( eventCallback_iifffifi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65629 :
		...
		( this->*( eventCallback_fifffifi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65630 :
		...
		( this->*( eventCallback_iffffifi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65631 :
		...
		( this->*( eventCallback_fffffifi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65632 :
		...
		( this->*( eventCallback_iiiiiffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65633 :
		...
		( this->*( eventCallback_fiiiiffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65634 :
		...
		( this->*( eventCallback_ifiiiffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65635 :
		...
		( this->*( eventCallback_ffiiiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65636 :
		...
		( this->*( eventCallback_iifiiffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65637 :
		...
		( this->*( eventCallback_fifiiffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65638 :
		...
		( this->*( eventCallback_iffiiffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65639 :
		...
		( this->*( eventCallback_fffiiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65640 :
		...
		( this->*( eventCallback_iiififfi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65641 :
		...
		( this->*( eventCallback_fiififfi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65642 :
		...
		( this->*( eventCallback_ifififfi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65643 :
		...
		( this->*( eventCallback_ffififfi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65644 :
		...
		( this->*( eventCallback_iiffiffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65645 :
		...
		( this->*( eventCallback_fiffiffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65646 :
		...
		( this->*( eventCallback_ifffiffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65647 :
		...
		( this->*( eventCallback_ffffiffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65648 :
		...
		( this->*( eventCallback_iiiifffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65649 :
		...
		( this->*( eventCallback_fiiifffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65650 :
		...
		( this->*( eventCallback_ifiifffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65651 :
		...
		( this->*( eventCallback_ffiifffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65652 :
		...
		( this->*( eventCallback_iififffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65653 :
		...
		( this->*( eventCallback_fififffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65654 :
		...
		( this->*( eventCallback_iffifffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65655 :
		...
		( this->*( eventCallback_fffifffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65656 :
		...
		( this->*( eventCallback_iiiffffi_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65657 :
		...
		( this->*( eventCallback_fiiffffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65658 :
		...
		( this->*( eventCallback_ififfffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65659 :
		...
		( this->*( eventCallback_ffiffffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65660 :
		...
		( this->*( eventCallback_iifffffi_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65661 :
		...
		( this->*( eventCallback_fifffffi_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65662 :
		...
		( this->*( eventCallback_iffffffi_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65663 :
		...
		( this->*( eventCallback_fffffffi_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], p_data[ 7 ] );
		break;
	...
	case 65664 :
		...
		( this->*( eventCallback_iiiiiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65665 :
		...
		( this->*( eventCallback_fiiiiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65666 :
		...
		( this->*( eventCallback_ifiiiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65667 :
		...
		( this->*( eventCallback_ffiiiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65668 :
		...
		( this->*( eventCallback_iifiiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65669 :
		...
		( this->*( eventCallback_fifiiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65670 :
		...
		( this->*( eventCallback_iffiiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65671 :
		...
		( this->*( eventCallback_fffiiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65672 :
		...
		( this->*( eventCallback_iiifiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65673 :
		...
		( this->*( eventCallback_fiifiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65674 :
		...
		( this->*( eventCallback_ififiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65675 :
		...
		( this->*( eventCallback_ffifiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65676 :
		...
		( this->*( eventCallback_iiffiiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65677 :
		...
		( this->*( eventCallback_fiffiiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65678 :
		...
		( this->*( eventCallback_ifffiiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65679 :
		...
		( this->*( eventCallback_ffffiiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65680 :
		...
		( this->*( eventCallback_iiiifiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65681 :
		...
		( this->*( eventCallback_fiiifiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65682 :
		...
		( this->*( eventCallback_ifiifiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65683 :
		...
		( this->*( eventCallback_ffiifiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65684 :
		...
		( this->*( eventCallback_iififiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65685 :
		...
		( this->*( eventCallback_fififiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65686 :
		...
		( this->*( eventCallback_iffifiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65687 :
		...
		( this->*( eventCallback_fffifiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65688 :
		...
		( this->*( eventCallback_iiiffiif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65689 :
		...
		( this->*( eventCallback_fiiffiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65690 :
		...
		( this->*( eventCallback_ififfiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65691 :
		...
		( this->*( eventCallback_ffiffiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65692 :
		...
		( this->*( eventCallback_iifffiif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65693 :
		...
		( this->*( eventCallback_fifffiif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65694 :
		...
		( this->*( eventCallback_iffffiif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65695 :
		...
		( this->*( eventCallback_fffffiif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65696 :
		...
		( this->*( eventCallback_iiiiifif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65697 :
		...
		( this->*( eventCallback_fiiiifif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65698 :
		...
		( this->*( eventCallback_ifiiifif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65699 :
		...
		( this->*( eventCallback_ffiiifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65700 :
		...
		( this->*( eventCallback_iifiifif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65701 :
		...
		( this->*( eventCallback_fifiifif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65702 :
		...
		( this->*( eventCallback_iffiifif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65703 :
		...
		( this->*( eventCallback_fffiifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65704 :
		...
		( this->*( eventCallback_iiififif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65705 :
		...
		( this->*( eventCallback_fiififif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65706 :
		...
		( this->*( eventCallback_ifififif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65707 :
		...
		( this->*( eventCallback_ffififif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65708 :
		...
		( this->*( eventCallback_iiffifif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65709 :
		...
		( this->*( eventCallback_fiffifif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65710 :
		...
		( this->*( eventCallback_ifffifif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65711 :
		...
		( this->*( eventCallback_ffffifif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65712 :
		...
		( this->*( eventCallback_iiiiffif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65713 :
		...
		( this->*( eventCallback_fiiiffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65714 :
		...
		( this->*( eventCallback_ifiiffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65715 :
		...
		( this->*( eventCallback_ffiiffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65716 :
		...
		( this->*( eventCallback_iififfif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65717 :
		...
		( this->*( eventCallback_fififfif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65718 :
		...
		( this->*( eventCallback_iffiffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65719 :
		...
		( this->*( eventCallback_fffiffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65720 :
		...
		( this->*( eventCallback_iiifffif_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65721 :
		...
		( this->*( eventCallback_fiifffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65722 :
		...
		( this->*( eventCallback_ififffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65723 :
		...
		( this->*( eventCallback_ffifffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65724 :
		...
		( this->*( eventCallback_iiffffif_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65725 :
		...
		( this->*( eventCallback_fiffffif_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65726 :
		...
		( this->*( eventCallback_ifffffif_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65727 :
		...
		( this->*( eventCallback_ffffffif_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65728 :
		...
		( this->*( eventCallback_iiiiiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65729 :
		...
		( this->*( eventCallback_fiiiiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65730 :
		...
		( this->*( eventCallback_ifiiiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65731 :
		...
		( this->*( eventCallback_ffiiiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65732 :
		...
		( this->*( eventCallback_iifiiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65733 :
		...
		( this->*( eventCallback_fifiiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65734 :
		...
		( this->*( eventCallback_iffiiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65735 :
		...
		( this->*( eventCallback_fffiiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65736 :
		...
		( this->*( eventCallback_iiifiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65737 :
		...
		( this->*( eventCallback_fiifiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65738 :
		...
		( this->*( eventCallback_ififiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65739 :
		...
		( this->*( eventCallback_ffifiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65740 :
		...
		( this->*( eventCallback_iiffiiff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65741 :
		...
		( this->*( eventCallback_fiffiiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65742 :
		...
		( this->*( eventCallback_ifffiiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65743 :
		...
		( this->*( eventCallback_ffffiiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65744 :
		...
		( this->*( eventCallback_iiiififf_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65745 :
		...
		( this->*( eventCallback_fiiififf_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65746 :
		...
		( this->*( eventCallback_ifiififf_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65747 :
		...
		( this->*( eventCallback_ffiififf_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65748 :
		...
		( this->*( eventCallback_iifififf_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65749 :
		...
		( this->*( eventCallback_fifififf_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65750 :
		...
		( this->*( eventCallback_iffififf_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65751 :
		...
		( this->*( eventCallback_fffififf_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65752 :
		...
		( this->*( eventCallback_iiiffiff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65753 :
		...
		( this->*( eventCallback_fiiffiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65754 :
		...
		( this->*( eventCallback_ififfiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65755 :
		...
		( this->*( eventCallback_ffiffiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65756 :
		...
		( this->*( eventCallback_iifffiff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65757 :
		...
		( this->*( eventCallback_fifffiff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65758 :
		...
		( this->*( eventCallback_iffffiff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65759 :
		...
		( this->*( eventCallback_fffffiff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65760 :
		...
		( this->*( eventCallback_iiiiifff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65761 :
		...
		( this->*( eventCallback_fiiiifff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65762 :
		...
		( this->*( eventCallback_ifiiifff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65763 :
		...
		( this->*( eventCallback_ffiiifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65764 :
		...
		( this->*( eventCallback_iifiifff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65765 :
		...
		( this->*( eventCallback_fifiifff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65766 :
		...
		( this->*( eventCallback_iffiifff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65767 :
		...
		( this->*( eventCallback_fffiifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65768 :
		...
		( this->*( eventCallback_iiififff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65769 :
		...
		( this->*( eventCallback_fiififff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65770 :
		...
		( this->*( eventCallback_ifififff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65771 :
		...
		( this->*( eventCallback_ffififff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65772 :
		...
		( this->*( eventCallback_iiffifff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65773 :
		...
		( this->*( eventCallback_fiffifff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65774 :
		...
		( this->*( eventCallback_ifffifff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65775 :
		...
		( this->*( eventCallback_ffffifff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65776 :
		...
		( this->*( eventCallback_iiiiffff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65777 :
		...
		( this->*( eventCallback_fiiiffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65778 :
		...
		( this->*( eventCallback_ifiiffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65779 :
		...
		( this->*( eventCallback_ffiiffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65780 :
		...
		( this->*( eventCallback_iififfff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65781 :
		...
		( this->*( eventCallback_fififfff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65782 :
		...
		( this->*( eventCallback_iffiffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65783 :
		...
		( this->*( eventCallback_fffiffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65784 :
		...
		( this->*( eventCallback_iiifffff_t )callback )( p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65785 :
		...
		( this->*( eventCallback_fiifffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65786 :
		...
		( this->*( eventCallback_ififffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65787 :
		...
		( this->*( eventCallback_ffifffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65788 :
		...
		( this->*( eventCallback_iiffffff_t )callback )( p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65789 :
		...
		( this->*( eventCallback_fiffffff_t )callback )( *( float * )&p_data[ 0 ], p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65790 :
		...
		( this->*( eventCallback_ifffffff_t )callback )( p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
	...
	case 65791 :
		...
		( this->*( eventCallback_ffffffff_t )callback )( *( float * )&p_data[ 0 ], *( float * )&p_data[ 1 ], *( float * )&p_data[ 2 ], *( float * )&p_data[ 3 ], *( float * )&p_data[ 4 ], *( float * )&p_data[ 5 ], *( float * )&p_data[ 6 ], *( float * )&p_data[ 7 ] );
		break;
