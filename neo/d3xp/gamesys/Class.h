...
public:
	...
	idEventArg( const class idEntity *p_data )	{ type = D_EVENT_ENTITY; value = reinterpret_cast<intptr_t>( p_data ); };
	idEventArg( const struct trace_s *p_data )	{ type = D_EVENT_TRACE; value = reinterpret_cast<intptr_t>( p_data ); };
};
...
#define new ID_DEBUG_NEW
	...
	bool						ProcessEventArgPtr( const idEventDef *ev, intptr_t *p_data );
